...
src_configure() {
	...
	myconf_gn+=" disable_histogram_support=true enable_background_contents=false enable_background_mode=false enable_mdns=true use_aura=false use_base_test_suite=false use_dawn=true use_dbus=true use_egl=false use_xkbcommon=true"
