...
src_install() {
	...
	rm "${D}/usr/$(get_libdir)/rust-${PV}/rustlib/components" || die
	rm "${D}/usr/$(get_libdir)/rust-${PV}/rustlib/install.log" || die
	rm "${D}/usr/$(get_libdir)/rust-${PV}/rustlib/manifest-rustc" || die
	rm "${D}/usr/$(get_libdir)/rust-${PV}/rustlib/rust-installer-version" || die
	rm "${D}/usr/$(get_libdir)/rust-${PV}/rustlib/uninstall.sh" || die
