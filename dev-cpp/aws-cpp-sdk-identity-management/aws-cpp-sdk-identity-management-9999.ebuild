...
DESCRIPTION="C++ interface for Amazon identity-management"
...
SLOT=0
DEPEND="
	>=dev-cpp/aws-cpp-sdk-core-${PV}
	>=dev-cpp/aws-cpp-sdk-cognito-identity-${PV}"
...
src_configure() {
    local mycmakeargs=(
        ...
        -DCPP_STANDARD="17"
        -DENABLE_TESTING=OFF
        -DBUILD_ONLY="identity-management"
